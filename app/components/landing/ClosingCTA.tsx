  ...
  return (
    <section id="cta" className="scroll-mt-24 px-6 py-20 md:py-28">
      <Reveal className="mx-auto max-w-6xl">
        <div className="rounded-2xl bg-near-black p-12 text-center !text-white md:p-20">
          ...
          <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
            <Link
              href="/candidates"
              className="rounded-full bg-white px-8 py-3 text-sm font-semibold text-near-black transition hover:opacity-90"
            >
              Get Started Free
            </Link>
            <a
              href="#employers"
              className="rounded-full border border-white px-8 py-3 text-sm font-semibold !text-white transition hover:bg-white hover:text-near-black"
            >
              Learn More
            </a>
          </div>
