...
function Card({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      data-slot="card"
      className={cn('rounded-2xl border border-light-border bg-secondary text-accent shadow-card', className)}
      {...props}
    />
  )
}
...
function CardTitle({ className, ...props }: React.ComponentProps<'h3'>) {
  return <h3 data-slot="card-title" className={cn('font-headings text-lg font-bold text-accent', className)} {...props} />
}
